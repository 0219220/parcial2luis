...
export default class SideBar extends Component {
    ...
    render() {
        ...
        return (
        <div className='side-bar' style={{backgroundColor: 'rgba(0, 0, 0, 0)'}}>
            <h1></h1>            
                ...
                <div className='container1' >
                    <div className='left'>
                        <div className='bio'>
                            ...
                            <div><h2>I am a content producer based in Guadalajara, I am skilled in photo and video editting and enjoy to work on projects as a producer. </h2></div>
                        </div>
                    </div>
                    <div className='center'>
                        <img src={luispp} className='biopp'></img>
                    </div>
